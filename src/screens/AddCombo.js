                    ...
                    <div className="form-body">
                      <div className="card-body">
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                placeholder="Enter Your Combo ID"
                                value={ProductId}
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                id="firstName"
                                className="form-control form-select"
                                placeholder="Enter your Combo Name"
                                value={name}
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                id="firstName"
                                className="form-control form-select"
                                placeholder="Enter your customer price (Website)"
                                value={websitePrice}
                                onChange={(e) =>
                        ...
                        <input
                          ...
                          value="Submit"
                        />
                        <a href="/combo" type="submit" class="btn btn-dark">
                          Cancel
                        </a>
                      </div>
                    </div>
