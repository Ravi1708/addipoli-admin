...
import { listitems, deleteitem, createitem } from "../actions/productActions";
...
const RawmaterialList = ({ match }) => {
  let history = useHistory();
  const dispatch = useDispatch();

  const itemList = useSelector((state) => state.itemList);
  const { loading, items, error, pages, page } = itemList;
